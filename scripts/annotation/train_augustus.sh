...
transcripts="../maker_round1/Vvi_Dakapo_without_chr00.all.maker.transcripts.fasta" #transcript fasta file, if left blank will look in maker_dir
...
if [ -z ${input_gff} ]
then
	input_gff="${maker_dir}/${fasta}.all.gff"
fi
if [ -z ${transcripts} ]
then
