...
#Set variables
threads=50
protein_fasta="/mnt/gs21/scratch/rittere5/witchs-broom/data/Vvinifera/Dakapo/dakapowt/assembly/VvDak_v1/VvDak_v1.1_protein_proper_format.fa" #input proteins fasta file
gff="/mnt/gs21/scratch/rittere5/witchs-broom/data/Vvinifera/Dakapo/dakapowt/assembly/VvDak_v1/VvDak_v1.1.gff" #input gff file
...
proteins="/mnt/gs21/scratch/rittere5/witchs-broom/data/Vvinifera/Dakapo/dakapowt/assembly/VvDak_v1/VvDak_v1.1_protein_proper_format.fa"
output="VvDak_v1.1"
echo ${proteins}
