...
input="consensus.fasta" #input fasta, if left blank, will look for it in current directory, mutually exclusive with input_dir
...
genomeSize=$(awk -v FS="," \
	...
	${path1}/samples.csv)
genomeSize2=$(python -c "print(2.5 * 1000000000)")
