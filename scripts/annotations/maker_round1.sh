...
then
	...
	${conda}/envs/maker/share/RepeatMasker/util/rmOutToGFF3.pl ../repeatmasker/Vvi_Dakapo_without_chr00.fa.out | \
...
#Get protein gff
protein_sources=$(cat protein_list.txt)
...
then
	...
	do
		...
		cat ../exonerate/${i} >> protein_alignments
	done
	#Convert to gff
